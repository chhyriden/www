...
//load parent CSS
if ( ! function_exists( 'exs_logistics_enqueue_static' ) ) :
	/**
	 * exs_logistics_enqueue_static
	 *
	 * @return void
	 * @since 1.0.0
	 */
	function exs_logistics_enqueue_static() {

		$min = exs_option( 'assets_min' ) && ! EXS_DEV_MODE ? 'min/' : '';
		//main theme css file
		wp_enqueue_style( 'exs-logistics-style', get_stylesheet_directory_uri() . '/assets/css/' . $min . 'main.css', array( 'exs-style' ), wp_get_theme()->get( 'Version' ) );
		...
		if ( ! empty( $exs_font_body->font ) || ! empty( $exs_font_headings->font ) ) {
			...
			*/
			...
			if ( 'off' !== esc_html_x( 'on', 'Google font: on or off', 'exs-logistics' ) ) {
...
add_action( 'wp_enqueue_scripts', 'exs_logistics_enqueue_static', 20 );

//theme options
if ( ! function_exists( 'exs_logistics_default_options' ) ) :
	function exs_logistics_default_options() {
		return array(
			'demo_number' => '',
			'colors_palette_block_heading' => '',
			'colorLight' => '#ffffff',
			'colorFont' => '#404862',
			'colorFontMuted' => '#5d6199',
			'colorBackground' => '#e8eefc',
			'colorBorder' => '#d0d9ef',
			'colorDark' => '#404862',
			'colorDarkMuted' => '#072d79',
			'colorMain' => '#024269',
			'colorMain2' => '#58a6e1',
			'colorMain3' => '#1877bf',
			'colorMain4' => '#005a87',
			...
			'colors_inverse_label_default' =>  esc_html__( 'Light', 'exs-logistics' ),
			'colors_inverse_label_inverse' =>  esc_html__( 'Dark', 'exs-logistics' ),
			...
			'copyright' => '4',
			'copyright_text' =>  esc_html__( '© [year] - All rights reserved', 'exs-logistics' ),
			'copyright_fluid' => '',
			'copyright_background' => 'i c c4',
			...
			'reading_time_prefix' => esc_html__( 'Read Time: ', 'exs-logistics' ),
			...
			'blog_single_post_nav_word_prev' => esc_html__( 'Previous', 'exs-logistics' ),
			'blog_single_post_nav_word_next' => esc_html__( 'Next', 'exs-logistics' ),
			'blog_single_related_posts_heading' => '',
			'blog_single_related_posts' => 'grid-3',
			'blog_single_related_posts_title' => esc_html__( 'You may also like...', 'exs-logistics' ),
			...
			'blog_single_related_posts_background' => 'l',
			...
			'blog_single_toc_after_first_p' => '2',
			'search_layout' => '',
			'search_layout_gap' => '',
			...
			'animation_extra' => '',
			'contact_message_success' => esc_html__( 'Message was sent!', 'exs-logistics' ),
			'contact_message_fail' => esc_html__( 'There was an error during message sending!', 'exs-logistics' ),
			'contact_email' => '',
			'contact_allow_custom' => '',
			'mailchimp_api_key' => '',
			'mailchimp_audience_id' => '',
			'mailchimp_message_success' => esc_html__( 'You have subscribed successfully!', 'exs-logistics' ),
			'mailchimp_message_fail' => esc_html__( 'There was an error during subscribing!', 'exs-logistics' ),
			'mailchimp_message_already' => esc_html__( 'You are already subscribed!', 'exs-logistics' ),
			'popup_extra' => '',
			'mouse_cursor_enabled' => '1',
			'mouse_cursor_background' => 'i c gradient horizontal',
			'mouse_cursor_border' => '',
			'mouse_cursor_size' => '28',
			'mouse_cursor_opacity' => '0.3',
			'mouse_cursor_opacity_hover' => '0.15',
			'mouse_cursor_hidden' => '',
			...
			'font_body_heading' => '',
			'font_body' => '{"font":"Nunito Sans","variant":["300","700"],"subset":[]}',
...
add_filter( 'exs_default_theme_options', 'exs_logistics_default_options' );

//filter page menu
if ( ! function_exists( 'exs_logistics_filter_wp_page_menu_args' ) ) :
	function exs_logistics_filter_wp_page_menu_args( $args ) {
...
add_filter( 'wp_page_menu_args', 'exs_logistics_filter_wp_page_menu_args' );

//set pages menu as a fallback menu to header menu if no menu set
if ( ! function_exists( 'exs_logistics_filter_wp_page_menu_primary_location' ) ) :
	function exs_logistics_filter_wp_page_menu_primary_location( $has_nav_menu, $location ) {
		return 'primary' === $location ? true : $has_nav_menu;
	}
endif;
add_filter( 'has_nav_menu', 'exs_logistics_filter_wp_page_menu_primary_location', 10, 2 );

//starter content
if ( ! function_exists( 'exs_logistics_starter_content' ) ) :
	function exs_logistics_starter_content() {
		return  array(
			'widgets'     => array(
			...
			'attachments' => array(
				'image-demo' => array(
					'post_title' => _x( 'Example image 1', 'Theme starter content', 'exs-logistics' ),
			...
			'posts'       => array(
				...
				'block_title' => array(
					'post_type'    => 'wp_block',
					'post_title'   => esc_html__( 'Title with subtitle', 'exs-logistics' ),
				...
				'postone'     => array(
					'post_type'    => 'post',
					'post_title'   => esc_html__( 'Single Post', 'exs-logistics' ),
					'post_content' => exs_get_html_markup_from_template( 'sample-post' ),
					'thumbnail'    => '{{image-demo}}',
					'taxonomy'     => array(
						'category' => array(
							array(
								'term' => esc_html__( 'Blog', 'exs-logistics' ),
								'slug' => 'blog',
							),
						),
					),
			...
			'nav_menus'   => array(
				...
				'primary'  => array(
					'name'  => esc_html__( 'Primary', 'exs-logistics' ),
					'items' => array(
						'link_home',
...
add_filter( 'exs_starter_content', 'exs_logistics_starter_content' );
