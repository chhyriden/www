...
if ( ! class_exists( 'Foodie_Review_Blog_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Foodie_Review_Blog_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$foodie_review_blog_contents = wp_remote_retrieve_body( $response );

			return $foodie_review_blog_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Foodie_Review_Blog_WPTT_WebFont_Loader( $url );
